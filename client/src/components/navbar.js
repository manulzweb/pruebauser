...
export const navBarComponent = () => {
  ...
  return `
    <header class="border-b border-[var(--border-main)] bg-[var(--bg-panel)]/90 backdrop-blur sticky top-0 z-50">
      <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a class="text-xl font-black text-[var(--brand-bg)] transition-colors hover:text-[var(--brand-hover)]" href="/dashboard">MovieSPA</a>
        <div class="flex items-center gap-4">
          <nav class="hidden gap-3 md:flex items-center">
            ...
            <a class="rounded-full px-4 py-2 text-sm font-semibold transition-all duration-300 ease-in-out ${isActive('/movies')}" href="/movies">Películas</a>
